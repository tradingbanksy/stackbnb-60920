...
import type { Itinerary, ItineraryDay, ItineraryItem, ItineraryItemCategory } from "@/features/trip-planner/types";
...
export default function SharedItinerary() {
  ...
  useEffect(() => {
    const fetchSharedItinerary = async () => {
      ...
      // Extract itinerary data from the stored JSON
      ...
      if (storedData.itinerary_data) {
        ...
        // Fallback for older shared itineraries without full data
        setItinerary({
          id: sharedData.id,
